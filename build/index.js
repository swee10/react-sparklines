...
exports.dataToPoints = exports.SparklinesText = exports.SparklinesNormalBand = exports.SparklinesReferenceLine = exports.SparklinesSpots = exports.SparklinesBars = exports.SparklinesCurve = exports.SparklinesLine = exports.Sparklines = undefined;
...
var SparklinesSpots = function (_React$Component) {
    ...
    _createClass(SparklinesSpots, [{
        ...
        value: function render() {
            var _props = this.props,
                currentPointIdx = _props.currentPointIdx,
                points = _props.points,
                width = _props.width,
                height = _props.height,
                size = _props.size,
            ...
            if (currentPointIdx || currentPointIdx === 0) {
                var currentSpot = _react2.default.createElement('circle', {
                    cx: points[currentPointIdx].x,
                    cy: points[currentPointIdx].y,
                    r: size,
                    style: style });
                return _react2.default.createElement(
                    'g',
